...
<head>
    ...
    <link rel="stylesheet"
    href="https://cdn.jsdelivr.net/npm/bootstrap-icon@1.50.5/font/bootstrap-icons.css">
    ...
    <div class="container d-flex justify-content-center align-items-center" style="margin-top: 60px">
        <div class="card" style:"width: 35%">
            <div class="card-body p-4">
                ...
                <p class="mt-2 text-center"> Sudah punya akun? <a href="{{ route('auth.login') }}" style="text-decoration: none"> Ayo masuk sayang! </a></p>
            </div>
        </div>
    </div>
